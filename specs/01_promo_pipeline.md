...
**接地の限界**: **GUI 未目視。** スポットライトの位置・カードの置き場・遷移は実機で見ていない (→ 2026-09-14 案内が始まることは rev45 の確認で見た。各歩の中身は未確認)。
...
- [x] rev44 (2026-09-12): 初回起動のナビゲーション (174〜178、契約 `FirstRunTour`。Lorekeel からの移植)。vitest 110 / build green。**GUI 未目視** (案内が始まることは rev45 の確認で見た。各歩の中身は未確認)
