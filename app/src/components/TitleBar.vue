...
<template>
  <div data-tauri-drag-region class="tb">
    ...
    <button class="tb-btn" :disabled="busy" :title="t('titleBar.history')" @click="emit('open-runs')">
    ...
    <button class="tb-btn" :disabled="busy" :title="t('titleBar.settings')" @click="emit('open-settings')">
